  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="hidden md:flex w-1/2 bg-gray-900 flex-col justify-between p-12">
        ...
        <div>
          <p className="text-4xl font-bold text-white mb-4">Commencez<br/>votre<br/><span className="italic text-yellow-500">aventure.</span></p>
          <p className="text-gray-400">Rejoignez 12 000+ apprenants et accédez à 280+ cours.</p>
        </div>
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-gray-500 mb-8">Déjà un compte ? <a href="/login" className="text-yellow-500 font-medium hover:underline">Se connecter</a></p>

          <div className="flex flex-col gap-4">
            <div className="flex gap-4">
              <div className="flex-1">
                <label className="text-sm font-medium text-gray-700 block mb-1">Prénom</label>
                <input type="text" placeholder="Prénom" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-yellow-500 transition"/>
              </div>
              <div className="flex-1">
                <label className="text-sm font-medium text-gray-700 block mb-1">Nom</label>
                <input type="text" placeholder="Nom" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:border-yellow-500 transition"/>
              </div>
            </div>
            <div>
