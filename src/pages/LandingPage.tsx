  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="fixed top-0 left-0 right-0 bg-white shadow-sm z-50 px-8 py-4 flex justify-between items-center">
        <h1 className="text-2xl font-bold">Nova<span className="text-yellow-500">Mind</span></h1>
      ...
      <section className="pt-32 pb-20 px-8 text-center">
        ...
        <p className="text-gray-500 text-lg max-w-xl mx-auto mb-8">NovaMind réunit des formateurs experts et des apprenants ambitieux sur une plateforme pensée pour la progression réelle.</p>
      ...
      <section id="avantages" className="px-8 py-20 bg-white">
        <p className="text-yellow-500 font-mono text-xs uppercase tracking-widest mb-2">Pourquoi NovaMind</p>
      ...
      <footer className="bg-black text-gray-500 text-center py-6 text-sm">
        © 2026 NovaMind. Tous droits réservés.
      </footer>
    </div>
  )
}
